...
Rails.application.config.assets.precompile += %w( ceilinglight.jpg )
Rails.application.config.assets.precompile += %w( stoplight.jpg )
Rails.application.config.assets.precompile += %w( tallbuildilng.jpg )
Rails.application.config.assets.precompile += %w( studio2.jpg )
