...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<actionpack>.freeze, ["< 5.2", ">= 3.2.0"])
      s.add_development_dependency(%q<rake>.freeze, ["~> 10.0"])
      s.add_development_dependency(%q<rspec>.freeze, ["~> 3.5.0"])
      s.add_development_dependency(%q<rspec-html-matchers>.freeze, ["~> 0.8.0"])
    else
      s.add_dependency(%q<actionpack>.freeze, ["< 5.2", ">= 3.2.0"])
      s.add_dependency(%q<rake>.freeze, ["~> 10.0"])
      s.add_dependency(%q<rspec>.freeze, ["~> 3.5.0"])
      s.add_dependency(%q<rspec-html-matchers>.freeze, ["~> 0.8.0"])
    end
  else
    s.add_dependency(%q<actionpack>.freeze, ["< 5.2", ">= 3.2.0"])
    s.add_dependency(%q<rake>.freeze, ["~> 10.0"])
